// @ts-nocheck
// ARCHIVED — preserved verbatim from master's frontend/src/App.tsx (a teammate's
// WebSocket + audio mock-session test harness). Kept here so the merge of this
// branch doesn't destroy that work. It is intentionally NOT imported anywhere.
